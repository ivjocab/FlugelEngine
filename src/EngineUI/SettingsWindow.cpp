...
int max_ticks = 60;
float fps;
void SettingsWindow::PerformanceGraphs()
{
...
void SettingsWindow::WindowOptions()
{
	bool ret = false;
...
void SettingsWindow::HardwareInfo()
{
...
void SettingsWindow::RenderOptions()
{
	bool ret = false;
...
void SettingsWindow::ReceiveEvents(std::vector<std::shared_ptr<Event>>& evt_vec) {
